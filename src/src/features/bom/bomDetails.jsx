        ...
        {isLoading ? (
          ...
          <>
            ...
            >
                  ...
                  filteredDataBom.map((item, index) => (
                    <Button
                      ...
                      sx={{
                        marginBottom: 1,
                        color:
                          selectedPartCode === item.partCode
                            ? "white"
                        ...
                        "&:hover": {
                          backgroundColor:
                            selectedPartCode === item.partCode
                              ? "#0d47a1"
                              : "rgba(0, 0, 0, 0.1)", // Maintain color on hover
                          color:
                            selectedPartCode === item.partCode
                              ? "white"
                              : "black", // Maintain text color on hover
                        },
                      }}
                    >
                      {item.partCode}
              ...
              <Box flex={0.9}>
                <TreeNode
                  currentFGPart={bomDetails}
                  selectedPartCode={selectedPartCode}
                />{" "}
                {/* Pass selectedPartCode to TreeNode */}
              </Box>
            </Box>
          </>
        )}
