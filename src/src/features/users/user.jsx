...
const Users = () => {
  ...
  console.log("userDepart", userDepart);
  ...
  const handleRadioChange = (entity) => {
    setEntityData({ entityDefWhs: entity.entityName });
  };
    ...
    <Box>
      {isLoading ? (
        ...
        <>
          ...
          <Header
            userDepart={branchList}
            entityData={entityData}
            handleCheckboxChange={handleCheckboxChange}
            handleRadioChange={handleRadioChange}
            handleConfirm={handleConfirm}
            handleIconClose={handleIconClose}
            entityDrawerOpen={popoverOpen}
            setEntityDrawerOpen={setPopoverOpen}
          />
        </>
      )}
    </Box>
