...
const SideBar = ({ isSideIcon }) => {
  ...
  const allSubMenu =
    branchType === "Y"
      ? allChild.filter((item) => {
          return (
            item.name != "Supplier Plan Upload" &&
            item.name != "Supplier Plan Creation"
          );
        })
      : allChild;
  ...
  return (
    <Drawer variant="persistent" open sx={sidebarStyles.drawer(isSideIcon)}>
      <Toolbar sx={sidebarStyles.toolbar}>
        {isSideIcon ? (
          <img
            src={cvsLogo}
            alt="Logo"
            style={sidebarStyles.logoImage(isSideIcon)}
          />
        ) : (
          <img
            src={covalsysLogo}
          ...
          <List key={index} sx={sidebarStyles.listWrapper}>
            {isSideIcon ? (
                ...
                <Tooltip title={headSection.headName} arrow placement="right">
                  <ListItemButton
                    ...
                    onClick={(e) =>
                      ...
                      handleClick(e, headSection.childName)
                    }
                  >
              ...
              <Accordion
                ...
                onChange={() =>
                  headSection.childName.length && handleAccordionToggle(index)
                }
              ...
              >
                ...
                >
                  ...
                  <Typography
                    component={Link}
                    to={headSection.route || "#"}
                    sx={sidebarStyles.iconTextSpacing}
                  >
                    {" "}
                ...
                >
                  <div style={sidebarStyles.iconWrapper}>
                    {React.cloneElement(subItem.iconMenu, {
                      ...
                      style: {
                        color: pathname === subItem.route ? "#000" : "inherit",
                      },
                    })}
                  </div>
                  <ListItemText
